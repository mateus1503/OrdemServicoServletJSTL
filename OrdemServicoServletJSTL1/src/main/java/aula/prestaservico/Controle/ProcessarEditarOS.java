...
public class ProcessarEditarOS extends HttpServlet {
    ...
    private static void insertOrdemServico(HttpServletRequest request, Cliente cliente, List<Veiculo> veiculos,
                                           List<Servico> servicos, OrdemServico ordemServico) {
